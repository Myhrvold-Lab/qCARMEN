...
def eqs_log(
    ...
    kcat_trans, kcat_cis, kcat_t7, kf_cis_target, kr_cis_target, \
        kf_cis_other, kr_cis_other, Rep_0, E_0, T7_0, DNA_tot, DNA = params
    ...
    def dAE_dt(variables):
        ...
        # Denominator from dividing Cas13 + Cas13-target + Cas13-other by Cas13 concentration
        c13 = (E_0 - AE) / (1 + kf_cis_target * T_t / (kr_cis_target + kcat_cis) + kf_cis_other * T_o / kr_cis_other)

        # Cas13-target cis-cleavage intermediate
